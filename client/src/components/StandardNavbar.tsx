                    ...
                    <div className="absolute top-full right-0 mt-1 w-56 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-50">
                      <div className="py-1">
                        ...
                        <button
                          ...
                          className="flex items-center w-full px-4 py-2 text-sm transition-colors duration-200 text-red-400 hover:bg-red-900/20 hover:text-red-300 border-t border-gray-700 mt-1 pt-2"
                        >
                  ...
                  <div>
                    ...
                    {isMobileAccountOpen && (
                      <div className="pl-4 space-y-1 mt-2 animate-in slide-in-from-top-1 duration-200">
                        ...
                        <button
                          onClick={handleSignOut}
                          className="flex items-center w-full px-3 py-2 text-sm rounded-md transition-colors duration-200 text-red-400 hover:bg-red-900/20 hover:text-red-300"
                        >
                          <LogOut className="h-4 w-4 mr-3" />
                          Sign Out
                        </button>
